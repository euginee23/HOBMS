...
<head>
    ...
    <title>Booking Confirmed — HOBMS</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { background: linear-gradient(135deg, #059669 0%, #16a34a 100%); padding: 40px 40px 32px; text-align: center; }
        ...
        .status-badge { display: inline-block; padding: 4px 12px; background: #dcfce7; color: #166534; font-size: 12px; font-weight: 700; border-radius: 999px; border: 1px solid #bbf7d0; }
        .cta-button { display: inline-block; margin-top: 8px; padding: 12px 28px; background: #059669; color: #ffffff; font-size: 14px; font-weight: 700; border-radius: 10px; text-decoration: none; }
        ...
        .footer-brand { font-size: 13px; font-weight: 700; color: #059669; letter-spacing: 0.5px; margin-bottom: 6px; }
    ...
    <div class="wrapper">
        <div class="card">
            <div class="header">
                ...
                <div class="header-sub">Your reservation has been approved</div>
            </div>

            <div class="body">
                <p class="greeting">Hi, <strong>{{ $booking->guest_name }}</strong>!</p>
                <p class="message">
                    Great news! Your booking at HOBMS has been <strong>confirmed</strong>. Please review the details below and arrive on your check-in date.
                </p>
                ...
                <div class="details-card">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value" style="font-weight: 700; color: #059669;">₱{{ number_format($booking->total_amount, 2) }}</span>
                    </div>
                    <div class="detail-row">
                ...
                <div class="cta-wrap">
                    <a href="{{ $booking->portalUrl }}" class="cta-button">View Booking Details</a>
                </div>

                <div class="security">
                    <strong>Payment reminder:</strong> Please prepare your payment of <strong>₱{{ number_format($booking->total_amount, 2) }}</strong> upon check-in unless otherwise arranged with our front desk.
                </div>
            </div>
