...
<head>
    ...
    <title>Password Reset Code — HOBMS</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { background: linear-gradient(135deg, #7c3aed 0%, #a855f7 100%); padding: 40px 40px 32px; text-align: center; }
        ...
        .otp-digit { display: inline-block; width: 56px; height: 64px; background: linear-gradient(145deg, #f5f3ff, #ede9fe); border: 2px solid #c4b5fd; border-radius: 14px; font-size: 32px; font-weight: 800; color: #7c3aed; text-align: center; line-height: 60px; letter-spacing: -1px; }
        ...
        .footer-brand { font-size: 13px; font-weight: 700; color: #7c3aed; letter-spacing: 0.5px; margin-bottom: 6px; }
