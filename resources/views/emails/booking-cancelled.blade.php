...
<head>
    ...
    <title>Booking Cancelled — HOBMS</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { background: linear-gradient(135deg, #dc2626 0%, #e11d48 100%); padding: 40px 40px 32px; text-align: center; }
        ...
        .status-badge { display: inline-block; padding: 4px 12px; background: #fee2e2; color: #991b1b; font-size: 12px; font-weight: 700; border-radius: 999px; border: 1px solid #fecaca; }
        .reason-card { background: #fef2f2; border-radius: 12px; padding: 16px 20px; font-size: 14px; color: #991b1b; line-height: 1.6; border: 1px solid #fecaca; margin-bottom: 28px; }
        .reason-card strong { color: #7f1d1d; }
        ...
        .footer-brand { font-size: 13px; font-weight: 700; color: #dc2626; letter-spacing: 0.5px; margin-bottom: 6px; }
    ...
    <div class="wrapper">
        <div class="card">
            <div class="header">
                ...
                <div class="header-sub">Your reservation has been cancelled</div>
            </div>

            <div class="body">
                <p class="greeting">Hi, <strong>{{ $booking->guest_name }}</strong>!</p>
                <p class="message">
                    We're writing to inform you that your booking at HOBMS has been <strong>cancelled</strong>. Please review the details below.
                </p>
                ...
                @if ($booking->cancellation_reason)
                    <div class="section-label">Reason for Cancellation</div>
                ...
                <div class="security">
                    <strong>Need to rebook?</strong> You can make a new reservation anytime through our website. If you have any questions, please contact our front desk.
                </div>
            </div>
